            ...
            <ul className='navbaritems  NavBar'>
                ...
                <div className='navbar-right-items'>
                    {auth ? <>
                        ...
                        <img src='' alt='https://www.pngkey.com/png/full/115-1150152_default-profile-picture-avatar-png-green.png' style={{height:"25px",width:"25px"}}/><Link to='/EditDetails' style={{color:"Black", textDecoration:"None",fontSize:"24px"}}>😊 Welcome {auth.result.uname}</Link>
